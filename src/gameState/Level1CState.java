...
import enemies.DarkEnergy;
import entity.BossSpider;
import entity.Enemy;
...
public class Level1CState extends GameState {
	...
	public void init() {
		...
		// backgrounds
		temple = new Background("/Backgrounds/bg_boss.png", 0.5, 0);
		
		// tilemap
		tileMap = new TileMap(30);
		tileMap.loadTiles("/Tilesets/sumNewest.png");
		tileMap.loadMap("/Maps/boss.txt");
		tileMap.setPosition(140, 0);
		tileMap.setTween(1);
		
		// player
		player = new Player(tileMap);
		player.setPosition(80, 250); //**************************player mark
	...
	private void populateEnemies() {
		enemies.clear();
		spirit = new BossSpider(tileMap, player, enemies, explosions);
