...
public class Level1BState extends GameState {
	...
	public void init() {
		...
		// backgrounds
		sky = new Background("/Backgrounds/bg_main.png", 0.5, 0);
		temple = new Background("/Backgrounds/tree2.png", 0.5, 0);
		
		// tilemap
		tileMap = new TileMap(30);
		tileMap.loadTiles("/Tilesets/sumNewest.png");
		tileMap.loadMap("/Maps/stateB.txt");
		...
		teleport.setPosition(2980, 220); //2850 320
