...
public class BossSpider extends Enemy {
	...
	public BossSpider(TileMap tm, Player p, ArrayList<Enemy> enemies, ArrayList<Explosion> explosions) {
	...
	public void update() {
		...
		if(steps[step] == 0) {
			...
			if(y == 60) {
				...
				if(dx == 1 && x > tileMap.getWidth() - 60) { //60
					dx = -1;
				}
			}
			if(stepCount % 60 == 0) {
